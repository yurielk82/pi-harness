...
- Route reconnaissance to scout, thinking and technical direction to lead-software-engineer or lead-data-scientist, planning to planner, plan critique to plan-reviewer, implementation to builder, data-engineer, analytics-engineer, or ml-engineer as appropriate, review to reviewer, testing to tester, ship-readiness work to release-manager, and documentation updates to documenter
...
- Use data-engineer for pipelines, warehouse models, SQL transformations, and data contracts
- Use analytics-engineer for metrics, semantic logic, dashboards, and analytical SQL
- Use ml-engineer for training, inference, evaluation, and model-serving systems
